# v8 (Alpha) Mainnet Upgrade Guide

Ixo v8 (Alpha) Gov Prop: <https://explorer.ixo.earth/ixo/gov/482>
...
1. Wait for Ixo to reach the upgrade height 17871000

2. Look for a panic message (`UPGRADE "Alpha" NEEDED at height: 17871000`),
